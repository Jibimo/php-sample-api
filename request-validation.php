 ...
 * @return bool|string
 */
function validateRequest($transactionId)
{
    ...
    return get("https://jibimo.com/sandbox/api/business/request_transaction/$transactionId", $headers);
}

$result = validateRequest(2313);
